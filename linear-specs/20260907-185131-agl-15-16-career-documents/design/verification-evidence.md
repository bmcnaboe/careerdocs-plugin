...
| US2-1    | integration         | `tests/integration/test_onboard.py::test_conflict_one_question`; unit: `test_merge.py`, `test_questions.py::test_example_yields_exactly_one_question` | pending |
| US2-2    | integration         | `tests/integration/test_onboard.py::test_apply_single_entry`; unit: `test_diff.py`, `test_merge.py::test_merged_diff_applies_cleanly` | pending |
| US2-3    | integration         | `tests/integration/test_onboard.py::test_resume_no_repeat`; unit: `test_state.py`, `test_questions.py::test_no_question_repeats_after_resume` | pending |
| US2-4    | integration         | `tests/integration/test_onboard.py::test_private_excluded`; unit: `test_visibility.py::test_export_excludes_private_and_is_derived` | pending |
| US2-5    | integration         | `tests/integration/test_basic_memory_provider.py`; unit: `test_basic_memory_provider.py` (same ids, derived markdown export) | pending |
