...
restatement of it. Read the core `career-documents` skill first, and generate the résumé
(`career-resume`) before this so the brief and map already exist.
