...
license: MIT
compatibility: "Python 3.11+; uv recommended. Requires the careerdocs core skill, an onboarded profile, and an existing brief and map for the role (from career-resume)."
metadata:
  version: "0.1.0"
