...
1. **Factual traceability** (always) — every content line is a plan unit or a template
   allowlist string, and every number and date traces to a cited entity. Stops invented
